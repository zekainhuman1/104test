<template>
  <div class="new_incom container">
    <h3 class="title">
      <a href="/arrived" class="text">Нові надходження</a>
      <div class="all">
        <a href="/arrived" class="">
          <div class="all_title">Дивитись всі</div>
        </a>
        <img
...
.product_card .labels, .product_card:hover>.control {
    display: flex;
    justify-content: space-between;
}
...
.price[data-v-4dbc45fc], .pricevalues[data-v-4dbc45fc] {
    align-items: center;
    display: flex;
}

.price[data-v-4dbc45fc] {
    justify-content: space-between;
    width: 100%;
}
