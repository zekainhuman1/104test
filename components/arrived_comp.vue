  ...
  <div>
    <div class="catalog container">
      <div class="catalog_wrapper">
        <aside class="filters">
          <div class="accordion">
            <button aria-controls="collapse92" class="flex" isopen="true">
              Ціна
              <svg
                color="#111827"
                fill="none"
                ...
                viewBox="2 0 12 10"
                aria-hidden="true"
                class="w-3 transition-all duration-100 transform rotate-180"
              >
                <path
                  d="M15 1.2l-7 7-7-7"
                  stroke-width="1"
            ...
            <div id="collapse92" class="content" style=""></div>
          </div>
        </aside>
        <div class="list_wrap">
          <div class="list">
            ...
            >
              ...
              <!---->
              <div class="labels">
                <div class="label" style="background-color: rgb(0, 0, 0)">
                  New!
                </div>
              </div>
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRJkif5HPPhPsAVNICZaHj5flvGpV3hjjaTtM8dj-zGSXzllfKJnQVSg29zlcgZT1ALyL4&amp;usqp=CAU"
                alt=""
                class="card_img"
              />
              ...
              <div class="rate">
                ...
                <div class="rating_num">2.7</div>
              </div>
              <div class="price">
                <div class="pricevalues">
                  <div class="currprice">1 005 ₴</div>
                  <del class="oldprice"> 1 206 ₴</del>
                </div>
                <div class="cart">
                  <img
            ...
            >
              ...
              <div class="price">
                <div class="pricevalues">
                  <div class="currprice">994 ₴</div>
                  <del class="oldprice"> 1 193 ₴</del>
                </div>
                <div class="cart">
                  <img
                    src="data:image/svg+xml;base64,"
            ...
            >
              ...
              <div class="rate">
                ...
                <div class="rating_num">1.8</div>
              </div>
              <div class="price">
                <div class="pricevalues">
                  <div class="currprice">458 ₴</div>
                  <del class="oldprice"> 549 ₴</del>
                </div>
                <div class="cart">
                  <img
                    src="data:image/svg+xml;base64,"
            ...
            >
              ...
              <div class="rate">
                ...
                <div class="rating_num">1.5</div>
              </div>
              <div class="price">
                <div class="pricevalues">
                  <div class="currprice">451 ₴</div>
                  <del class="oldprice"> 541 ₴</del>
                </div>
                <div class="cart">
                  <img
                    src="data:image/svg+xml;base64,"
            ...
            >
              ...
              <div class="price">
                <div class="pricevalues">
                  <div class="currprice">651 ₴</div>
                  <del class="oldprice"> 781 ₴</del>
                </div>
                <div class="cart">
                  <img
                    src="data:image/svg+xml;base64,"
            ...
            >
              ...
              <div class="price">
                <div class="pricevalues">
                  <div class="currprice">471 ₴</div>
                  <del class="oldprice"> 566 ₴</del>
                </div>
                <div class="cart">
                  <img
                    src="data:image/svg+xml;base64,"
            ...
            >
              ...
              <div class="rate">
                ...
                <div class="rating_num">2.9</div>
              </div>
              <div class="price">
                <div class="pricevalues">
                  <div class="currprice">425 ₴</div>
                  <del class="oldprice"> 510 ₴</del>
                </div>
                <div class="cart">
                  <img
                    src="data:image/svg+xml;base64,"
            ...
            >
              ...
              <div class="price">
                <div class="pricevalues">
                  <div class="currprice">585 ₴</div>
                  <del class="oldprice"> 702 ₴</del>
                </div>
                <div class="cart">
                  <img
                    src="data:image/svg+xml;base64,"
            ...
            >
              ...
              <div class="rate">
                <div class="ratings">
                  <div class="empty-stars"></div>
                  <div class="full-stars" style="width: 42%"></div>
                </div>
                <div class="rating_num">2.1</div>
              </div>
          ...
          <div class="pagination-container pag">
            <div class="el-pagination is-background">
              <span class="el-pagination__total">Total 10</span
              ><span class="el-pagination__sizes"
                ><div class="el-select el-select--mini">
                  ...
                  <div
                    ...
                    style="display: none; min-width: 139.969px"
                  >
              ...
              <button type="button" disabled="disabled" class="btn-next">
                <i class="custom-arrow_next"></i></button><span class="el-pagination__jump"
                >Go to
    ...
    <script>
import header_bottom from "~/components/header_bottom.vue";
...
.favor {
  background-image: url(data:image/svg+xml;base64,);
}
