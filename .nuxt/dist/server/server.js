...
/******/ 			var chunk = require("./" + ({"1":"components/arrived-comp","2":"components/footerr","3":"components/header-bottom","4":"components/new-incom","5":"components/slider","6":"components/tabs-cont","7":"pages/arrived","8":"pages/index"}[chunkId]||chunkId) + ".js");
...
__webpack_require__.d(components_namespaceObject, "ArrivedComp", function() { return ArrivedComp; });
__webpack_require__.d(components_namespaceObject, "Footerr", function() { return Footerr; });
__webpack_require__.d(components_namespaceObject, "HeaderBottom", function() { return HeaderBottom; });
__webpack_require__.d(components_namespaceObject, "NewIncom", function() { return NewIncom; });
__webpack_require__.d(components_namespaceObject, "Slider", function() { return Slider; });
__webpack_require__.d(components_namespaceObject, "TabsCont", function() { return TabsCont; });
...
const _18df8f58 = () => interopDefault(__webpack_require__.e(/* import() | pages/arrived */ 7).then(__webpack_require__.bind(null, 65)));
const _418f69f9 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 8).then(__webpack_require__.bind(null, 66)));
...
const ArrivedComp = () => __webpack_require__.e(/* import() | components/arrived-comp */ 1).then(__webpack_require__.bind(null, 61)).then(c => wrapFunctional(c.default || c));
const Footerr = () => __webpack_require__.e(/* import() | components/footerr */ 2).then(__webpack_require__.bind(null, 40)).then(c => wrapFunctional(c.default || c));
const HeaderBottom = () => __webpack_require__.e(/* import() | components/header-bottom */ 3).then(__webpack_require__.bind(null, 32)).then(c => wrapFunctional(c.default || c));
const NewIncom = () => __webpack_require__.e(/* import() | components/new-incom */ 4).then(__webpack_require__.bind(null, 59)).then(c => wrapFunctional(c.default || c));
const Slider = () => __webpack_require__.e(/* import() | components/slider */ 5).then(__webpack_require__.bind(null, 56)).then(c => wrapFunctional(c.default || c));
const TabsCont = () => __webpack_require__.e(/* import() | components/tabs-cont */ 6).then(__webpack_require__.bind(null, 62)).then(c => wrapFunctional(c.default || c));
